let CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		let body = document.getElementById("particleBg");
		...
		canvas.element.style = "background:#000;position: fixed; top: 0; left: 0; z-index: -10;";
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		let width = document.getElementById("particleBg").style.width;
		let height = document.getElementById("particleBg").style.height;
